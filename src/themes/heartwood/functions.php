...
if (!function_exists('enqueue_scripts')) {
    ...
    function enqueue_scripts()
    {
        ...
        wp_enqueue_style( 'typekit-styles', 'https://use.typekit.net/hwr1wli.css', array(), null );
        wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Inter&family=Inter+Tight:ital,wght@0,200;0,400;0,700;1,200;1,400;1,700&display=swap', false );
